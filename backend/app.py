...
from backend.api.test import sayhi
from api.student.read import all_students, single_student, students_subject
from api.teacher.read import all_teachers, single_teacher
